...
def train(model_0gradient,model_1gradient,model_2gradient,model_tgradient,Nf_dataset,Nu_dataset,loss_fn,device,num_epochs,optimizer,text_x,text_t,text_y):
    ...
    for epoch_idx in range(num_epochs):
        ...
        for batch_Nf,batch_Nu in zip(data_loader_Nf,data_loader_Nu):
            ...
            u_xx = model_2gradient(torch.cat([inp_t_Nf, inp_x_Nf], dim=1)).to(device)
...
def Burgers1d_PINN(Nf_dataset, Nu_dataset,text_x,text_t,text_y,num_epochs=100):
    ...
    model_0gradient = NN(20,2,1,10)
    model_1gradient = NN(20,2,1,5)
    model_2gradient = NN(20, 2, 1, 5)
    model_tgradient = NN(20, 2, 1, 5)
