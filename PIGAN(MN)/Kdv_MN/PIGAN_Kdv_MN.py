...
import scipy.io
import torch
from PIGAN_Kdv_model_MN import Kdv_MN


def main():
    # 读入测试集
    np.random.seed(42)
    test = scipy.io.loadmat('./Data/Kdv1d_exact.mat')
    test_point_t = test['t']
    ...
    for i in range(run_times):
        PIGAN_error, PIGAN_time = Kdv_MN(Nf_dataset, Nu_dataset, test_point, test_real_value)
        MSE += PIGAN_error['MSE']
