# File      :PIGAN_AllenCahn_MN.py
# Time      :2021/5/21--21:00
# Author    :JF Li
# Version   :python 3.7
...
import scipy.io
import torch
from PIGAN_AllenCahn_model_MN import AllenCahn_MN
...
def main():
    ...
    for i in range(run_times):
        PIGAN_error, PIGAN_time = AllenCahn_MN(Nf_dataset, Nu_dataset, test_point, test_real_value)
        MSE += PIGAN_error['MSE']
