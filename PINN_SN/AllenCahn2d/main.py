...
import scipy.io
import csv
from AllenCahn2d_PINN import AllenCahn2d_PINN
...
def main():
    ...
    for i in range(run_times):
        ...
        AllenCahn2d_error_evermoment, AllenCahn2d_error,Inference_time, value_4, value_8= AllenCahn2d_PINN(Nf_dataset, Nu_dataset,text_x,text_t,text_y)
    ...
    dataframe.to_csv("./Results/PINN_SN_AllenCahn2d_noise10_evermoment_loss.csv", index=False,header=False, sep=',')
    ...
    # dataframe.to_csv("./Results/PINN_SN_AllenCahn2d_noise10_value_4_approximate.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/PINN_SN_AllenCahn2d_noise10_value_8_approximate.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/PINN_SN_AllenCahn2d_noise10_value_4_exact.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/PINN_SN_AllenCahn2d_noise10_value_8_exact.csv", index=False, header=False, sep=',')

    with open('./Results/PINN_SN_AllenCahn2d_loss_noise10.txt', 'w') as f:  # 设置文件对象
