...
def main():
    ...
    sio.savemat('./data/AllenCahn_training_Nf.mat', {'coordinate': Nf_coordinate})
    #构造Nu训练集
    Nu = 1000000
    #边界1
    ...
    z_set = np.sin(np.pi*x_set)*np.sin(np.pi*y_set)
    ...
    sio.savemat('./data/AllenCahn_training_Nu.mat', {'coordinate': Nu_coordinate[:,0:3],'value':Nu_coordinate[:,-1].reshape(Nu,1)})
