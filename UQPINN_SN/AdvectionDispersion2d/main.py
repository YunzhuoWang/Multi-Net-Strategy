...
def main():
    ...
    dataframe.to_csv("./Results/UQPINN_SN_AdvectionDispersion2d_noise10_evermoment_loss.csv", index=False,header=False, sep=',')
    ...
    # dataframe.to_csv("./Results/UQPINN_SN_AdvectionDispersion2d_noise10_value_4_approximate.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/UQPINN_SN_AdvectionDispersion2d_noise10_value_8_approximate.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/UQPINN_SN_AdvectionDispersion2d_noise10_value_4_exact.csv", index=False, header=False, sep=',')
    #
    ...
    # dataframe.to_csv("./Results/UQPINN_SN_AdvectionDispersion2d_noise10_value_8_exact.csv", index=False, header=False, sep=',')

    with open('./Results/UQPINN_SN_AdvectionDispersion2d_loss_noise10.txt', 'w') as f:  # 设置文件对象
