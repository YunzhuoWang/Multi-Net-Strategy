...
import scipy.io
import torch
from PIGAN_Burgers_1d_model import Burgers_1d
...
def main():
    ...
    for i in range(run_times):
        PIGAN_error, PIGAN_time = Burgers_1d(Nf_dataset, Nu_dataset, test_point, test_real_value)
        MSE += PIGAN_error['MSE']
