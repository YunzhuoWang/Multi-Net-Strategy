...
def main():
    ...
    # 重构训练集
    training_Nf = scipy.io.loadmat('./Data/AllenCahn_training_Nf1.mat')
    ...
    scipy.io.savemat('./Data/AllenCahn_training_Nf.mat', {'coordinate': Nf_point})

    # 重构边界集
    training_Nu = scipy.io.loadmat('./Data/AllenCahn_training_Nu1.mat')
    ...
    scipy.io.savemat('./Data/AllenCahn_training_Nu.mat', {'coordinate': Nu_point, 'value': Nu_point_value})

    # 重构测试集
    training_test = scipy.io.loadmat('./Data/AllenCahn_exact1.mat')
    ...
    scipy.io.savemat('./Data/AllenCahn_exact.mat',
