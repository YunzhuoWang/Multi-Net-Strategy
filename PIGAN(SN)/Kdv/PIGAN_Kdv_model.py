# File      :PIGAN_Kdv_model.py
# Time      :2021/5/21--19:28
# Author    :JF Li
# Version   :python 3.7
    ...
    for itr in range(num_iter):
        ...
        for batch_Nf, batch_Nu in zip(dataloader_Nf, dataloader_Nu):
            ...
            train_point_interior_pred = generator(
                torch.cat([train_point_interior_t, train_point_interior_x], dim = 1)).to(device)
            ...
            u_xxx = autograd.grad(outputs = u_xx, inputs = train_point_interior_x,
...
def Kdv(Nf_dataset, Nu_dataset, test_point, test_real_value):
    # 初始设置
